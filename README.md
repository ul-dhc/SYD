...
The public, reader-facing concept is available in [concept.html](concept.html). Its concise source text is kept in [docs/product-concept.md](docs/product-concept.md). A permanent data-preparation guide is available in [data-preparation.html](data-preparation.html).
